...
# id1 is an array that contain address and port
id1 = db.AddDataNode("localhost", 4017) 
adr1 = id1[0]
port1 = id1[1]
...
print(id1)
try:
	# db.AddBlockToInode("/hola/cheo.txt", [(id1, "1")])
	db.AddBlockToInode("/hola/cheo.txt", [(id1)])
except:
