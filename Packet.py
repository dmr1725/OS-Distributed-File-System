...
class Packet:
	...
	def getEncodedPacket(self):
		...
		# print(type(json.dumps(self.packet).encode()), 'getEncodedPacket')
		print(json.dumps(self.packet).encode())
	...
	def DecodePacket(self, packet):
		...
		# print(packet, type(packet), 'line 46 file Packet.py')
